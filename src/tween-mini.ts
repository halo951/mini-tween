...
import type { EasingFunction, UnknownProps, InterpolationFunction } from './types'

import { Linear as DefaultInterpolation } from './interpolation/linear'
import { Linear as DefaultEasing } from './easing/linear'
...
export class Tween<T extends UnknownProps = any> {
    ...
    private _initialRepeat: number = 0
    ...
    private _easingFunction: EasingFunction = DefaultEasing.None
    private _interpolationFunction: InterpolationFunction = DefaultInterpolation
    ...
    private _onEveryStartCallbackFired: boolean = false
    ...
    private _isChainStopped: boolean = false
    ...
    duration(duration: number = 1000): this {
        this._duration = duration < 0 ? 0 : duration
        return this
    }

    dynamic(dynamic: boolean = false): this {
    ...
    easing(easingFunction: EasingFunction = DefaultEasing.None): this {
        this._easingFunction = easingFunction
        return this
    }

    interpolation(interpolationFunction: InterpolationFunction = DefaultInterpolation): this {
